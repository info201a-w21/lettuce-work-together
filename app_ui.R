...
intro_panel <- tabPanel(
  ...
  p(style = "font-size:18px;", strong("Team Lettuce Work Together"), " 
  ...
  needs, and food deserts.",
    p(
      ...
      HTML(paste0(a("Feeding America",
     href = "https://secure.feedingamerica.org/site/Donation2?29411.donation=form1&df_id=29411&mfc_pref=T&s_src=Y21XP1B1Y&s_subsrc=c&s_keyword=feeding%20america&gclid=CjwKCAiAhbeCBhBcEiwAkv2cYyCjU5N8k3ALk3ExtioTjaZqxr90jkOtfUNTAclG2ZJi6p1Mo-HB9xoCNcYQAvD_BwE&gclsrc=aw.ds"), ",")),
      " a nonprofit organization with
  a network of over 200 food banks, to understand how food insecurity in the
  U.S. has changed over time. This organization drew local food insecurity and 
  ...
  Using this data enabled us to explore food insecurity at the county, 
  congressional district, and state levels. In addition, this data let us 
  explore questions about the scale of American food insecurity and the
  budget shortfalls of existing food assistance programs."
    ),
    p(
      style = "font-size:16px;", "In addition, we utilized data 
      calculated by USDA's ",
    ...
    the success of food assistance programs, as well as the existence of 
...
concl_panel <- tabPanel(
  ...
  p(
    ...
    strong("U.S national food insecurity rates have been steadily decreasing"),
    ...
    disproportionately affected people."), "In addition to experiencing 
    food insecurity rates that are above the U.S. national average, Black 
    and Hispanic Americans are around twice as likely to experience food 
    insecurity than White Americans.",
    ...
    p(
      ...
      factors on food insecurity in the U.S., we created a map to understand
      where the rate of food-insecure people is greater than the 
      high poverty threshold.",
      em("In other words, it examines where people are not poor yet still 
      food insecure."), "Our map reveals that the", strong("American Midwest"), 
      "tends to have more financially-able food insecure people. 
      Additionally,", strong("Vermont"),"stands out as a state with 
      consistently high levels of food insecure people who have the resources
      to purchase healthy foods. While there are many explanations for 
      this,", strong("it suggests that these states tend to have more food
      deserts, where there are fewer ways to access and purchase 
      nutritious foods.")),
