...
foodsec_18 <- fa_2018 %>% summarize(
  State, X2018 = ..2018.Food.Insecurity.Rate)
foodsec_17 <- fa_2017 %>% summarize(
  State, X2017 = ..2017.Food.Insecurity.Rate)
foodsec_16 <- fa_2016 %>% summarize(
  State, X2016 = ..2016.Food.Insecurity.Rate)
foodsec_15 <- fa_2015 %>% summarize(
  State, X2015 = ..2015.Food.Insecurity.Rate)
foodsec_14 <- fa_2014 %>% summarize(
  State, X2014 = ..2014.Food.Insecurity.Rate)
foodsec_13 <- fa_2013 %>% summarize(
  State, X2013 = ..2013.Food.Insecurity.Rate)
foodsec_12 <- fa_2012 %>% summarize(
  State, X2012 = ..2012.Food.Insecurity.Rate)
foodsec_11 <- fa_2011 %>% summarize(
  State = County..State, X2011 = ..2011.Food.Insecurity.Rate)
foodsec_10 <- fa_2010 %>% summarize(
  State, X2010 = ..2010.Food.Insecurity.Rate)
foodsec_09 <- fa_2009 %>% summarize(
  State = State.Name,
  X2009 = Food.Insecurity.Rate..aggregate.of.counties.)
