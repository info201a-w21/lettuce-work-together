...
library(tidyverse)
library(dplyr)
setwd("C:/Users/starr/Google Drive/Main Projects/School (UW)/2020-2021/Winter Quarter/Technical Foundations (INFO 201)/lettuce-work-together/scripts")
```


## Table of Aggregated Data
```{r aggregated table, echo=FALSE, eval=TRUE}
source("Table of Summary Info.R")
kable(financial_df) %>% 
...
```{r, echo=FALSE}
source("Chart 2 - Shortfall per Insecure 2018.R")
