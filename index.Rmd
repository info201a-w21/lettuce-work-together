...
### Purpose 
Using a scatterplot makes the data easier to interpret and more visually pleasing. Each point on the plot represents a US state and we can observe each state's relationship between food insecurity and meal cost. From the chart, we can tell that food insecurity and meal cost differ between states. 
...
- The observations raise questions about the impact of meal cost on food insecurity and vice versa. By looking at the chart, we can say that lower the meal cost, lower the food insecurity rate in general. 